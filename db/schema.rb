...
ActiveRecord::Schema.define(version: 2021_10_18_104237) do
  ...
  create_table 'episodes', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci', force: :cascade do |t|
  ...
  create_table 'survey_answers', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index ['line_account_id'], name: 'index_survey_answers_on_line_account_id'
    t.index ['line_friend_id'], name: 'index_survey_answers_on_line_friend_id'
    t.index ['survey_id'], name: 'index_survey_answers_on_survey_id'
    t.index ['survey_question_id'], name: 'index_survey_answers_on_survey_question_id'
  end

  create_table 'survey_friends', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci', force: :cascade do |t|
    t.bigint 'survey_id'
    t.bigint 'line_friend_id'
    t.integer 'answer_count', default: 0
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index ['line_friend_id'], name: 'index_survey_friends_on_line_friend_id'
    t.index ['survey_id'], name: 'index_survey_friends_on_survey_id'
  end
  ...
  add_foreign_key 'survey_answers', 'line_accounts'
  add_foreign_key 'survey_answers', 'line_friends'
  add_foreign_key 'survey_answers', 'survey_questions'
  add_foreign_key 'survey_answers', 'surveys'
  add_foreign_key 'survey_friends', 'line_friends'
