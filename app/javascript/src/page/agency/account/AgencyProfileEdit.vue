...
export default {
  ...
  methods: {
    ...mapActions('agency', ['updateAgencyProfile']),

    submitUpdateInfo(e) {
      this.submitted = true;
      this.updateAgencyProfile(_.omit(this.agencyFormData, ['email']))
        .then(_ => {
          Util.showSuccessThenRedirect('契約者情報の変更は完了しました。', `${this.userRootUrl}/agency`);
        })
        .catch(error => {
