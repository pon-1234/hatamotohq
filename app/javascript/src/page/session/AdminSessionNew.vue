            ...
            <div class="card">
              ...
              <div class="card-body p-4">
                <div class="text-center w-75 m-auto">
                  ...
                  <p class="text-muted mb-4">管理パネルにアクセスするには、メールアドレスとパスワードを入力してください。</p>
                </div>
                <form ref="form" @submit.prevent="onSubmit" :action="getAction()" method="post">
                  ...
                  <div class="form-group">
                    ...
                    <input-password
                      name="admin[password]"
                      :password.sync="adminData.password"
                    ></input-password>
                    <!-- END: Input password component -->
                  </div>
                  <div class="form-group mb-3">
                    <div class="custom-control custom-checkbox">
                      <input type="checkbox" name="admin[remember_me]" class="custom-control-input" id="checkbox-signin" v-model="adminData.remember_me" checked>
