      ...
      <div class="card-body">
        <div class="form-group d-flex">
          ...
          <div class="flex-grow-1 d-flex">
            <input type="checkbox" id="scenario-onoff" checked data-switch="success" v-model="scenarioData.status" true-value="enabled" false-value="disabled" ref="status"/>
          ...
          <div class="w-100 form-group d-flex">
            ...
            <div class="flex-grow-1">
              <div class="custom-control custom-radio custom-control-inline">
                  <input type="radio" id="targetAll" name="target" value="all" v-model="target" class="custom-control-input">
                  <label class="custom-control-label" for="targetAll">全員</label>
              </div>
              <div class="custom-control custom-radio custom-control-inline">
                  <input type="radio" id="targetTags" name="target" value="tags" v-model="target" class="custom-control-input">
        ...
        <div class="mt-2">
          <div class="form-group d-flex">
            ...
            <div class="flex-grow-1">
              <div class="custom-control custom-radio custom-control-inline">
                  <input type="radio" id="typeManual" value="manual" v-model="scenarioData.type" class="custom-control-input">
                  <label class="custom-control-label" for="typeManual">選択なし</label>
              </div>
              <div class="custom-control custom-radio custom-control-inline">
                  <input type="radio" id="typeAuto" value="auto" v-model="scenarioData.type" class="custom-control-input">
        ...
        <div class="mt-2">
          <div class="d-flex flex-start">
            <div class="fw-200">
              ...
              <span class="text-sm text-muted">作成後に変更不可</span>
            </div>

            <div class="flex-grow-1">
              <div class="custom-control custom-radio custom-control-inline">
                  <input type="radio" id="modeElapsedTime" value="elapsed_time" v-model="scenarioData.mode" :disabled="scenario_id" class="custom-control-input">
                  <label class="custom-control-label" for="modeElapsedTime">経過時間で指定</label>
              </div>
              <div class="custom-control custom-radio custom-control-inline">
                  <input type="radio" id="modeAuto" value="time" v-model="scenarioData.mode" :disabled="scenario_id" class="custom-control-input">
