      ...
      <div class="modal-content p-0">
        ...
        <div class="modal-body" v-if="friendDetail">
          <div class="center" style="text-align: center">
            <img v-lazy="avatarImgObj" style="width: 150px; height: 150px; object-fit: cover; border-radius: 150px" />
          </div>
          ...
          <table
            ...
            id="table-friend"
            v-if="!isShowTags"
            style="width: 100%; margin: 0; max-width: initial"
          >
            <tbody>
              <tr>
                <th>名前</th>
        ...
        <div class="modal-footer flex center">
          <button type="button" class="btn btn-common01" v-if="!isShowTags" @click="viewProfile()">
            プロフィールを見る
          </button>
          <div v-if="isShowTags" class="btn btn-common01" @click="editTag">更新</div>
        </div>
      </div>
    </div>
  </div>
