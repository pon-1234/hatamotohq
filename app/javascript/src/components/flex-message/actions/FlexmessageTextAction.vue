<template>
  <div>
    <p class="text-right" @click="expand()"> <span class="float-left">テキスト</span> <i class="mdi mdi-arrow-expand" aria-hidden="true"></i></p>
    ...
    <div class="card" >
      ...
      <div class="card-body">
        <div class="form-group row">
          ...
          <div class="col-sm-8">
            <input type="text" :name="'text_'+name" class="form-control" v-model.trim="text" @change="input"
              v-validate="'required'">
          </div>
        </div>
        <div class="form-group row">
