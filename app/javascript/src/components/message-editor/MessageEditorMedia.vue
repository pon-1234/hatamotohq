  ...
  <div>
    ...
    <div v-else>
      <div
        ...
        :class="errors.first('media-template' + index) ? 'invalid-box' : ''"
      >
        <div class="figure figure-grid-sm my-4">
          ...
          >
            ...
            <span v-else-if="data.type === 'audio'"
              >ボイスメッセージをアップロード</span
            >
          </a>
          <div class="text-muted opacity-30">
            ...
            <i
              ...
              class="mdi mdi-video mdi-3x"
            ></i>
            <i
              v-else-if="data.type === 'audio'"
              class="mdi mdi-voice mdi-3x"
            ></i>
          </div>
        </div>
      </div>
      <error-message
        :message="errors.first('media-template' + index)"
      ></error-message>
      <modal-select-media
        :types="[data.type]"
