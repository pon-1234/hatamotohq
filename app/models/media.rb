...
class Media < ApplicationRecord
  ...
  validates :file, content_type: ['audio/m4a', 'audio/x-m4a', 'audio/mp4', 'video/mp4', 'video/quicktime', 'audio/mpeg',
                                  'audio/vnd.wave', 'audio/wav', 'audio/x-ms-wma', 'video/x-ms-asf', 'video/x-ms-wma'], if: :type_audio?
